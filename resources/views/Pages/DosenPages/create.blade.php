                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="tamatan_terakhir"
                                                                        class="form-control" placeholder="Tamatan Terakhir"
                                                                        name="tamatan_terakhir">
                                                            ...
                                                            <div class="col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label for="NIDN">Nomor Induk Dosen Nasional (NIDN)
                                                                    </label>
