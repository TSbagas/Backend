                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <a href="/sejarah/addsejarah" class="btn btn-success float-end ms-2 py-1"><i
                                    ...
                                    <tbody>
                                        @foreach ($sejarah as $s)
                                            <tr>
                                                ...
                                                <td>{{ $s->updated_at }}</td>
                                                <td>{{ $s->created_at }}</td>
                                                <td><a href="/sejarah/{{ $s->id }}/edit" class="btn btn-primary"><i
                                                            class="bi bi-pencil-square"></i></a>
                                                    <button
                                                        onclick="confirmDelete('{{ route('sejarah.destroy', $s->id) }}')"
